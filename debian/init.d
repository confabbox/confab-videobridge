#! /bin/sh
#
# INIT script for Confab Videobridge
# Version: 1.0  01-May-2014  yasen@bluejimp.com
#
### BEGIN INIT INFO
# Provides:          confab-videobridge
# Required-Start:    $local_fs $remote_fs
# Required-Stop:     $local_fs $remote_fs
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Confab Videobridge
...
if [ -f /etc/confab/videobridge/config ]; then
    . /etc/confab/videobridge/config
fi

PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
DAEMON=/usr/share/confab-videobridge/jvb.sh
NAME=jvb
USER=jvb
...
TMPPATH=/var/run/confab-videobridge
PIDFILE=/var/run/confab-videobridge.pid
LOGFILE=/var/log/confab/jvb.log
DESC=confab-videobridge
