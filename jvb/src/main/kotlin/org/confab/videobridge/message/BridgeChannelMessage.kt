 ...
 */
package org.confab.videobridge.message
...
import org.confab.utils.ResettableLazy
import org.confab.videobridge.cc.allocation.VideoConstraints
import java.util.concurrent.ConcurrentHashMap
import java.util.concurrent.atomic.AtomicLong

/**
 * Represent a message sent over the "bridge channel" between an endpoint (or "client") and confab-videobridge, or
 * between two confab-videobridge instances over a relay connection.
 *
 ...
 *
 * This format is no longer used in confab-meet and is considered deprecated. The semantics are equivalent to
...
class SenderVideoConstraintsMessage(val videoConstraints: VideoConstraints) : BridgeChannelMessage(TYPE) {
     ...
     * Serialize manually because it's faster than Jackson.
     *
     * We use the "idealHeight" format that the confab-meet client expects.
     */
    override fun createJson(): String =
