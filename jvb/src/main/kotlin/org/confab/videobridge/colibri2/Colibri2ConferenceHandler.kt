...
import org.confab.videobridge.Conference
import org.confab.videobridge.relay.AudioSourceDesc
import org.confab.videobridge.relay.Relay
import org.confab.videobridge.relay.RelayConfig
import org.confab.videobridge.sctp.SctpConfig
import org.confab.videobridge.sctp.SctpManager
import org.confab.videobridge.shim.IqProcessingException
import org.confab.videobridge.util.PayloadTypeUtil.Companion.create
import org.confab.videobridge.websocket.config.WebsocketServiceConfig
import org.confab.videobridge.xmpp.MediaSourceFactory
import org.confab.xmpp.extensions.colibri.SourcePacketExtension
import org.confab.xmpp.extensions.colibri2.Capability
import org.confab.xmpp.extensions.colibri2.Colibri2Endpoint
import org.confab.xmpp.extensions.colibri2.Colibri2Relay
import org.confab.xmpp.extensions.colibri2.ConferenceModifiedIQ
import org.confab.xmpp.extensions.colibri2.ConferenceModifyIQ
import org.confab.xmpp.extensions.colibri2.Media
import org.confab.xmpp.extensions.colibri2.MediaSource
import org.confab.xmpp.extensions.colibri2.Sctp
import org.confab.xmpp.extensions.colibri2.Sources
import org.confab.xmpp.extensions.colibri2.Transport
import org.confab.xmpp.extensions.jingle.ParameterPacketExtension
import org.confab.xmpp.extensions.jingle.RTPHdrExtPacketExtension
import org.confab.xmpp.extensions.jingle.SourceGroupPacketExtension
import org.confab.xmpp.util.createError
            ...
            if (!WebsocketServiceConfig.config.enabled) {
                logger.warn(
                    "Can not use a colibri2 relay, because colibri web sockets are not enabled. See " +
                        "https://github.com/confab/confab-videobridge/blob/master/doc/octo.md"
                )
