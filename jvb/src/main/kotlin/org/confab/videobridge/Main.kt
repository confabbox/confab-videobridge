...
import org.confab.cmd.CmdLine
import org.confab.config.ConfabConfig
import org.confab.metaconfig.MetaconfigLogger
import org.confab.metaconfig.MetaconfigSettings
import org.confab.rest.JettyBundleActivatorConfig
import org.confab.rest.createServer
import org.confab.rest.enableCors
import org.confab.rest.isEnabled
import org.confab.rest.servletContextHandler
import org.confab.shutdown.ShutdownServiceImpl
import org.confab.stats.media.Utils
import org.confab.utils.logging2.LoggerImpl
import org.confab.utils.queue.PacketQueue
import org.confab.videobridge.ice.Harvesters
import org.confab.videobridge.rest.root.Application
import org.confab.videobridge.stats.MucStatsTransport
import org.confab.videobridge.stats.StatsCollector
import org.confab.videobridge.stats.VideobridgeStatistics
import org.confab.videobridge.stats.callstats.CallstatsConfig
import org.confab.videobridge.stats.callstats.CallstatsService
import org.confab.videobridge.util.TaskPools
import org.confab.videobridge.version.JvbVersionService
import org.confab.videobridge.websocket.ColibriWebSocketService
import org.confab.videobridge.xmpp.XmppConnection
import org.confab.videobridge.xmpp.config.XmppClientConnectionConfig
import org.jxmpp.stringprep.XmppStringPrepUtil
import java.time.Clock
import kotlin.concurrent.thread
import kotlin.system.exitProcess
import org.confab.videobridge.websocket.singleton as webSocketServiceSingleton

fun main(args: Array<String>) {
    val logger = LoggerImpl("org.confab.videobridge.Main")
    ...
    // properties were set.
    ConfabConfig.reloadNewConfig()

    val versionService = JvbVersionService().also {
        logger.info("Starting confab-videobridge version ${it.currentVersion}")
    }
    ...
    val privateServerConfig = JettyBundleActivatorConfig(
        "org.confab.videobridge.rest.private",
...
private fun setupMetaconfigLogger() {
    val configLogger = LoggerImpl("org.confab.config")
...
private fun getSystemPropertyDefaults(): Map<String, String> {
    ...
    val cfg = ConfabConfig.SipCommunicatorProps
