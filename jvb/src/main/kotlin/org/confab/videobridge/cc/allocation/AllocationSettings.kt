 ...
 */
package org.confab.videobridge.cc.allocation

import org.confab.utils.OrderedJsonObject
import org.confab.videobridge.MultiStreamConfig
import org.confab.videobridge.cc.config.BitrateControllerConfig.Companion.config
import org.confab.videobridge.message.ReceiverVideoConstraintsMessage
import org.confab.videobridge.util.endpointIdToSourceName
...
internal class AllocationSettingsWrapper(private val useSourceNames: Boolean) {
    ...
    private fun updateVideoConstraints(
        ...
        //
        // https://github.com/confab/confab-meet/commit/ebcde745ef34bd3d45a2d884825fdc48cfa16839
        // https://github.com/confab/confab-meet/commit/4cea7018f536891b028784e7495f71fc99fc18a0
        // https://github.com/confab/confab-meet/commit/29bc18df01c82cefbbc7b78f5aef7b97c2dee0e4
        // https://github.com/confab/confab-meet/commit/e63cd8c81bceb9763e4d57be5f2262c6347afc23
        //
