 ...
 */
package org.confab.videobridge.cc.vp9

import org.confab.nlj.PacketInfo
import org.confab.nlj.RtpLayerDesc.Companion.indexString
import org.confab.nlj.codec.vpx.VpxUtils.Companion.applyExtendedPictureIdDelta
import org.confab.nlj.codec.vpx.VpxUtils.Companion.applyTl0PicIdxDelta
import org.confab.nlj.codec.vpx.VpxUtils.Companion.getExtendedPictureIdDelta
import org.confab.nlj.codec.vpx.VpxUtils.Companion.getTl0PicIdxDelta
import org.confab.nlj.format.PayloadType
import org.confab.nlj.rtp.codec.vp9.Vp9Packet
import org.confab.rtp.rtcp.RtcpSrPacket
import org.confab.rtp.util.RtpUtils.Companion.applySequenceNumberDelta
import org.confab.rtp.util.RtpUtils.Companion.applyTimestampDelta
import org.confab.rtp.util.RtpUtils.Companion.getSequenceNumberDelta
import org.confab.rtp.util.RtpUtils.Companion.getTimestampDiff
import org.confab.rtp.util.isNewerThan
import org.confab.utils.logging.DiagnosticContext
import org.confab.utils.logging.TimeSeriesLogger
import org.confab.utils.logging2.Logger
import org.confab.utils.logging2.createChildLogger
import org.confab.utils.times
import org.confab.videobridge.cc.AdaptiveSourceProjectionContext
import org.confab.videobridge.cc.RewriteException
import org.confab.videobridge.cc.RtpState
