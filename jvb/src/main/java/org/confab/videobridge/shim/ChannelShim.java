 ...
 */
package org.confab.videobridge.shim;
        ...
        throws IqProcessingException
    {
        if (MultiStreamConfig.config.getEnabled())
        {
            for (SourcePacketExtension s: sources)
            {
                ...
                // https://github.com/confab/confab-xmpp-extensions/blob/b208e4bc96de30adae14f86515934293cd203138/src/main/java/org/confab/xmpp/extensions/colibri/ColibriBuilder.java#L157
            }
        }
