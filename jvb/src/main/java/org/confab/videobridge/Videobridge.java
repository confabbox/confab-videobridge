...
import org.confab.nlj.*;
import org.confab.shutdown.*;
import org.confab.utils.*;
import org.confab.utils.event.*;
import org.confab.utils.logging2.*;
import org.confab.utils.queue.*;
import org.confab.utils.stats.*;
import org.confab.utils.version.*;
import org.confab.videobridge.health.*;
import org.confab.videobridge.load_management.*;
import org.confab.videobridge.relay.*;
import org.confab.videobridge.shutdown.*;
import org.confab.videobridge.stats.*;
import org.confab.videobridge.util.*;
import org.confab.videobridge.xmpp.*;
import org.confab.xmpp.extensions.*;
import org.confab.xmpp.extensions.colibri.*;
import org.confab.xmpp.extensions.colibri2.*;
import org.confab.xmpp.extensions.health.*;
import org.confab.xmpp.extensions.jingle.*;
...
import static org.confab.videobridge.colibri2.Colibri2UtilKt.createConferenceAlreadyExistsError;
import static org.confab.videobridge.colibri2.Colibri2UtilKt.createConferenceNotFoundError;
import static org.confab.xmpp.util.ErrorUtilKt.createError;

/**
 * Represents the Confab Videobridge which creates, lists and destroys
...
public class Videobridge
{
    ...
    /**
     * The REST-like HTTP/JSON API of Confab Videobridge.
     */
    public static final String REST_API = "rest";

    /**
     * The (base) <tt>System</tt> and/or <tt>ConfigurationService</tt> property
     * of the REST-like HTTP/JSON API of Confab Videobridge.
     *
     * NOTE: Previously, the rest API name ("org.confab.videobridge.rest")
     * conflicted with other values in the new config, since we have
     * other properties scoped *under* "org.confab.videobridge.rest".   The
     ...
     */
    public static final String REST_API_PNAME = "org.confab.videobridge." + REST_API + "_api_temp";
    ...
    static
    {
        org.confab.rtp.util.BufferPool.Companion.setGetArray(ByteBufferPool::getBuffer);
        org.confab.rtp.util.BufferPool.Companion.setReturnArray(buffer -> {
            ByteBufferPool.returnBuffer(buffer);
            return Unit.INSTANCE;
        });
        org.confab.nlj.util.BufferPool.Companion.setGetBuffer(ByteBufferPool::getBuffer);
        org.confab.nlj.util.BufferPool.Companion.setReturnBuffer(buffer -> {
            ByteBufferPool.returnBuffer(buffer);
            return Unit.INSTANCE;
        });
    }
