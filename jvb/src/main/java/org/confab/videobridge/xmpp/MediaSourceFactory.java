 ...
 */
package org.confab.videobridge.xmpp;

import org.jetbrains.annotations.*;
import org.confab.nlj.*;
import org.confab.nlj.rtp.*;
import org.confab.utils.logging2.*;
import org.confab.videobridge.MultiStreamConfig;
import org.confab.xmpp.extensions.colibri.*;
import org.confab.xmpp.extensions.jingle.*;
import org.confab.xmpp.extensions.confabbox.*;
...
public class MediaSourceFactory
{
    ...
    /**
     * libconfab isn't aware of the group semantics names defined in
     * {@link SourceGroupPacketExtension}, which is how we distinguish secondary
     * ssrcs, so we'll translate them into constants defined in libconfab
     */
    ...
    )
    {
        ...
        Arrays.asList(
            ...
            groups.forEach(group -> {
                ...
                // the groups.
                // https://github.com/confab/confab/blob/7eabaab0fca37711813965d66a0720d1545f6c48/src/net/java/sip/communicator/impl/protocol/jabber/extensions/colibri/ColibriBuilder.java#L188
        ...
        // https://github.com/confab/confab/blob/7eabaab0fca37711813965d66a0720d1545f6c48/src/net/java/sip/communicator/impl/protocol/jabber/extensions/colibri/ColibriBuilder.java#L162
     ...
     * a {@link SSRCInfoPacketExtension}, but in confab-videobridge we only
