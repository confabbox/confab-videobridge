...
import org.confab.rtp.rtcp.rtcpfb.payload_specific_fb.*;
import org.confab.rtp.rtp.*;
import org.confab.utils.dsi.*;
import org.confab.utils.logging.*;
...
import org.confab.videobridge.colibri2.*;
import org.confab.videobridge.message.*;
import org.confab.videobridge.relay.*;
import org.confab.videobridge.shim.*;
...
/**
 * Represents a conference in the terms of Confab Videobridge.
 *
     ...
     implements AbstractEndpointMessageTransport.EndpointMessageTransportEventHandler
{
     ...
     * conference in the terms of Confab Videobridge which has a specific
     * (unique) ID.
     *
