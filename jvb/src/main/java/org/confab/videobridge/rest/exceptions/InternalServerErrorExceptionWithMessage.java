...
package org.confab.videobridge.rest.exceptions;
...
/**
 * The ctor for {@link InternalServerErrorException} which takes in a String doesn't
...
{
    public InternalServerErrorExceptionWithMessage(String message)
    {
        super(Response.status(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, message).build());
    }
}
