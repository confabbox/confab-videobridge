...
import org.confab_modified.sctp4j.*;

import static org.confab.videobridge.sctp.SctpConfig.config;
...
public class SctpManager {
     ...
     * in order to change from a buffer that was allocated by confab-sctp
