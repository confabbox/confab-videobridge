...
package org.confab.videobridge.rest.root.colibri;
...
public class ColibriResourceTest
{
    ...
    public void testAllResourcesAreBehindConfig()
    {
        Reflections reflections = new Reflections(new ConfigurationBuilder()
                .setUrls(ClasspathHelper.forPackage("org.confab.videobridge.rest.root.colibri"))
                .filterInputsBy(new FilterBuilder().includePackage("org.confab.videobridge.rest.root.colibri"))
