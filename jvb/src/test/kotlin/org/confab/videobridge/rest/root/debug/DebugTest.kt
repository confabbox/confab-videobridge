...
package org.confab.videobridge.rest.root.debug
...
import org.confab.health.HealthCheckService
...
import org.confab.videobridge.rest.RestApis
import org.confab.videobridge.rest.annotations.EnabledByConfig
    ...
    fun testAllResourcesAreBehindConfig() {
        val reflections = Reflections(
            ConfigurationBuilder()
                .setUrls(ClasspathHelper.forPackage("org.confab.videobridge.rest.root.debug"))
                .filterInputsBy(FilterBuilder().includePackage("org.confab.videobridge.rest.root.debug"))
