...
private fun legacyConfigStatsEnabled(enabled: Boolean = true) = "org.confab.videobridge.ENABLE_STATISTICS=$enabled"

private fun legacyConfigAllStatsTransports(enabled: Boolean = true) = """
    org.confab.videobridge.ENABLE_STATISTICS=$enabled
    org.confab.videobridge.STATISTICS_TRANSPORT=muc,callstats.io
""".trimIndent()
