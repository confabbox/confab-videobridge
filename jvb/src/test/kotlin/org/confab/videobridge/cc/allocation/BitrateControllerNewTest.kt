...
import org.confab.config.setNewConfig
import org.confab.nlj.MediaSourceDesc
import org.confab.nlj.PacketInfo
import org.confab.nlj.RtpEncodingDesc
...
import org.confab.nlj.util.mbps
...
import org.confab.videobridge.configWithMultiStreamEnabled
    ...
    init {
        ...
        context("Allocation") {
            ...
            context("Tile view 360p") {
                ...
                bc.bc.allocationSettings.lastN shouldBe -1
                // The legacy API (currently used by confab-meet) uses "selected count > 0" to infer TileView,
            ...
            context("Selected sources should override the dominant speaker (with new signaling)") {
                ...
                // The exact flow of this scenario was taken from a (non-confab-meet) client.
                bc.setEndpointOrdering(A, B, C, D)
