 ...
 */
package org.confab.nlj.rtp.bandwidthestimation
...
import org.confab.nlj.util.atRate
import org.confab.nlj.util.bits
import org.confab.nlj.util.bps
import org.confab.nlj.util.bytes
import org.confab.nlj.util.mbps
import org.confab.test.concurrent.FakeScheduledExecutorService
...
class BandwidthEstimationTest : ShouldSpec() {
    ...
    init {
        /* Emulate the fields that confab-videobridge puts in its DiagnosticContexts. */
