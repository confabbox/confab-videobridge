...
import org.confab.nlj.util.safeShutdown
import org.confab.test_utils.Pcaps
...
fun main() {
    ...
    org.confab.rtp.util.BufferPool.getArray = ::getBuffer
    org.confab.rtp.util.BufferPool.returnArray = ::returnBuffer
