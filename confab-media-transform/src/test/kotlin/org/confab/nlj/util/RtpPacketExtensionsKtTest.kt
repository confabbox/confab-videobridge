...
import org.confab.rtp.extensions.plus
import org.confab.rtp.rtp.RtpPacket
import org.confab.rtp.util.byteBufferOf
import java.nio.ByteBuffer

class RtpPacketExtensionsKtTest : ShouldSpec() {
    override fun isolationMode(): IsolationMode? = IsolationMode.InstancePerLeaf

    val payload = org.confab.rtp.extensions.bytearray.byteArrayOf(
        0x01, 0x02, 0x03, 0x04,
        0x05, 0x06, 0x07, 0x08,
        0x09, 0x0A, 0x0B, 0x0C
    )

    val buf = org.confab.rtp.extensions.bytearray.byteArrayOf(
        // Dummy header data
