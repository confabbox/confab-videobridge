...
import org.confab.nlj.AudioLevelListener
import org.confab.nlj.PacketInfo
import org.confab.nlj.rtp.AudioRtpPacket
import org.confab.nlj.rtp.RtpExtensionType.SSRC_AUDIO_LEVEL
...
class AudioLevelReader(
    ...
    companion object {
        ...
        private val forwardedSilencePacketsLimit: Int by config {
            "jmt.audio.level.forwarded-silence-packets-limit".from(ConfabConfig.newConfig)
        }
    }
}
