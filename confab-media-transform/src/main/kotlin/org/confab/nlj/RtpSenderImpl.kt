...
import org.confab.nlj.rtcp.KeyframeRequester
import org.confab.nlj.rtcp.NackHandler
import org.confab.nlj.rtcp.RtcpEventNotifier
import org.confab.nlj.rtcp.RtcpSrUpdater
import org.confab.nlj.rtp.TransportCcEngine
import org.confab.nlj.rtp.bandwidthestimation.BandwidthEstimator
import org.confab.nlj.rtp.bandwidthestimation.GoogleCcEstimator
...
import org.confab.nlj.transform.node.AudioRedHandler
import org.confab.nlj.transform.node.ConsumerNode
import org.confab.nlj.transform.node.Node
import org.confab.nlj.transform.node.PacketCacher
...
import org.confab.nlj.transform.node.SrtcpEncryptNode
import org.confab.nlj.transform.node.SrtpEncryptNode
import org.confab.nlj.transform.node.ToggleablePcapWriter
import org.confab.nlj.transform.node.outgoing.AbsSendTime
import org.confab.nlj.transform.node.outgoing.HeaderExtEncoder
import org.confab.nlj.transform.node.outgoing.HeaderExtStripper
import org.confab.nlj.transform.node.outgoing.OutgoingStatisticsTracker
import org.confab.nlj.transform.node.outgoing.ProbingDataSender
import org.confab.nlj.transform.node.outgoing.RetransmissionSender
import org.confab.nlj.transform.node.outgoing.SentRtcpStats
import org.confab.nlj.transform.node.outgoing.TccSeqNumTagger
import org.confab.nlj.transform.pipeline
import org.confab.nlj.util.BufferPool
import org.confab.nlj.util.PacketInfoQueue
import org.confab.nlj.util.StreamInformationStore
...
class RtpSenderImpl(
    ...
    companion object {
        ...
        private val queueSize: Int by config("jmt.transceiver.send.queue-size".from(ConfabConfig.newConfig))
